...
if __name__ == '__main__':
    ...
    """
    voluntarios = ['Alexandre', 'João', 'Natanael', 'Renato', 'Eduardo', 'Leonardo', 'Ronaldo',
                   'Ferreira', 'Santos', 'Monticelli', 'Claudio', 'Nelson', 'Fernando', 'Adriano',
                   'Amaral', 'Edmundo', 'Adilson', 'Romildo', 'David', 'Kaue', 'Fabio', 'Davi',
                   'Antonio', 'Tarcitano'
                   ]
